...
<div class="container">
    <form class="formContainer" action="ordenes2.php" method="POST">
        ...
        <div class="formGroup mb-0">
            ...
            <button type="submit" onclick=this.form.action="additem.php?identificacion=<?php echo $row['identificacion'];?>&codigo=<?php echo $row['codigo'];?>" class="btn btn-secondary" value="Agregar">AGR ITEM</button>
            <button type="submit"  onclick=this.form.action="mostraritems.php?identificacion=<?php echo '$identificacion';?>&codigo=<?php echo '$codigo';?>" class="btn btn-success" value="mostraritem">MOSTRAR ITEMS</button>
            <button type="submit" onclick=this.form.action="guardaritems.php" class="btn btn-primary" value="agregar">GUARDAR</button>
            <button type="submit" onclick=this.form.action="modificaritem.php?identificacion=<?php echo $row['identificacion'];?>&codigo=<?php echo $row['codigo'];?>" class="btn btn-secondary" value="MODIFICAR">MODIFICAR ITEMS</button>
            <button type="submit" onclick=this.form.action="elitems.php?identificacion=<?php echo $row['identificacion'];?>&codigo=<?php echo $row['codigo'];?>" class="btn btn-primary" value="MODIFICAR">ELIMINAR ITEMS</button>
